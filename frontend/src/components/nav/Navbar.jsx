        ...
        <Fragment>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                        <div className="flex justify-start lg:w-0 lg:flex-1">
                            <a href="#">
                                <h1 className='text-2xl font-serif text-blue-500'>Riadi.</h1>
                            </a>
                        </div>
                        ...
                        <nav className="hidden md:flex space-x-10">
                            <div className="relative">
                                ...
                                <button
                                    type="button"
                                    className="
                   group bg-white rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 border-0 focus:border-0 pb-8'
                  "
                                    onClick={() => (setFlyer(!flyer), setFlyerTwo(false))}
                                >
                                    <span>Five Column</span>
                                    {/*
          ...
          */}{" "}
                        ...
                        <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                            <a
                                href="#"
                                className="whitespace-nowrap text-2xl font-extrabold  text-black"
                            >
                                <CiSearch />
                            </a>
                            <a
