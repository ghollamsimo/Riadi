...
const Pay = ({setOpenModal , id}) => {
  ...
  //  console.log('jsususus' , id)
    ...
    useEffect(() => {
        dispatch(fetchRiadwhoReserved(id))
        setTimeout(() => {
        setLoading(false)
        } , 500)
    }, [dispatch]);
    const handleStatusBooked = () => {
        dispatch(UpdateStatusToBooked(id , {booked}))
                        ...
                        <div
                            ...
                            <div
                                ...
                                {loading ? (
                                    ...
                                    <>
                                        <main
                                            className='container px-3 mt-5 mb-24 lg:mb-32 flex flex-col-reverse lg:flex-row'>
                                            ...
                                            <div className='w-fit lg:w-3/5 xl:w-2/3 lg:pr-10 '>
                                                <div
                                                    ...
                                                    <h1 className='text-3xl lg:text-4xl font-semibold'>Confirm and
                                                        payment</h1>
                                                ...
                                                <div
                                                    ...
                                                    <div className="flex flex-col space-y-4"><h3
                                                        ...
                                                        <div
                                                            ...
                                                            <span>{riad?.currency} {riad?.prix} x {reservation?.night} day</span><span>{riad?.currency} {riad?.prix * reservation?.night}</span>
                                                        </div>
                                                        <div
                                                            className="flex justify-between text-neutral-6000 dark:text-neutral-300">
                                                        ...
                                                        <div className="flex justify-between font-semibold">
                                                            <span>Total</span><span>{riad?.currency} {riad?.prix * reservation?.night}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
