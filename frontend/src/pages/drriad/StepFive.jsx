...
const StepFive = ({ handleChange, handleNext, handlePrev , handleCover}) => {
                    ...
                    <div className="mt-5 ">
                        <div
                            ...
                            <div className="space-y-1 text-center">
                                <svg className="mx-auto h-12 w-12 text-neutral-400" stroke="currentColor" fill="none"
                                ...
                                <div className="flex text-sm text-neutral-6000 dark:text-neutral-300"><label
                                    ...
                                    id="file-upload" name="cover" type="file" onChange={handleCoverChange} className="sr-only"/></label><p
                            ...
                            <div
                                ...
                                <div className="space-y-1 text-center">
                                    <label htmlFor="file-upload-2"
                                        ...
                                        <input multiple onChange={handleFileChange} id="file-upload-2" name="image[]"
