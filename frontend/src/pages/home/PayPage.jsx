                                                ...
                                                <div
                                                    ...
                                                    <button
                                                        ...
                                                        <div className="flex flex-col">
                                                            ...
                                                            <span className="mt-1.5 text-lg font-semibold">{night} \night</span>
                                                        </div>
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                ...
                                                                                <path fillRule="evenodd"
                                                                                      d="M3.75 12a.75.75 0 01.75-.75h15a.75.75 0 010 1.5h-15a.75.75 0 01-.75-.75z" clipRule="evenodd"></path>
                                                                            </svg>
                                                                        </button>
                                                                        <input type='number' name='date' value={night}
                                                                               readOnly
