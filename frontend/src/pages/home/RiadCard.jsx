                    ...
                    <div className="grid grid-cols-2 gap-6 mt-10 lg:gap-14 lg:grid-cols-3">
                        <div className="relative group">
                            ...
                            <div className="absolute left-3 top-3">
                                <p className="sm:px-3 sm:py-1 px-1.5 py-1 text-[8px] sm:text-xs font-bold flex tracking-wide text-white  bg-[#111827] rounded-full gap-2"> <span><CiLocationOn className='mt-0.5'/></span> Marrakech</p>
                            </div>
